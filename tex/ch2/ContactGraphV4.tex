...
To show that any realization of a perfectly weighted snowflake tree is a subgraph of the triangular lattice unit distance graph, first consider the canonical position where $v_0$ is at origin.  The six paths from $v_0$ shall have a radian measure of $\frac{\pi}{6}$ between consecutive paths from $v_0$.  
