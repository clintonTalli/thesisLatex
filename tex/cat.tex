...
\begin{eqnarray*}
2\sin \lr{ \frac{\pi}{3} + \phi_i } - 2 \sin \frac{\pi}{3} &\leq& \sqrt{3} + \frac{1}{100N} + 2 \delta_i + \lr{ \sqrt{3}- 2 \sin \lr{\frac{\pi}{3} + \alpha_{i+1} } }\\
2\lr{\sin \frac{\pi}{3} + \cos \frac{\pi}{3} \lr{\phi_i - \frac{\pi}{3}}} - \sqrt{3} &\leq& 2\sqrt{3} + \frac{1}{5s^\kappa - 1} + \frac{48}{s^{2\kappa - 1}} - 2 \lr{\sin \frac{\pi}{3} + \cos \frac{\pi}{3} \lr{\alpha_{i+1} - \frac{\pi}{3} } }\\
2\lr{\sin \frac{\pi}{3} + \cos \frac{\pi}{3} \lr{\phi_i - \frac{\pi}{3}}} - \sqrt{3} &\leq& 2\sqrt{3} + \frac{1}{5s^\kappa - 1} + \frac{48}{s^{2\kappa - 1}} - 2 \lr{\sin \frac{\pi}{3} + \cos \frac{\pi}{3} \lr{\alpha_{i+1} - \frac{\pi}{3} } }\\
\phi_i &\leq& \sqrt{3} + \frac{s^{k-1} + 192}{4 s^{2k-1}} - \alpha_{i+1} - \frac{\pi}{3} + \frac{\pi}{3}\\
&\leq& \sqrt{3} + \frac{48}{s^k}
\end{eqnarray*}
...
The diameter of the rhombus can be approximated by $1$.
...
\omega_i &\leq&+ \frac{1}{5s^\kappa - 1} + \frac{48}{s^{2\kappa - 1}} +\sqrt{3} - 2 \lr{\sin \frac{\pi}{3} + \cos \frac{\pi}{3} \lr{\alpha_{i+1} - \frac{\pi}{3} } }\\
&\leq&  \frac{s^{k-1} + 192}{4 s^{2k-1}} - \alpha_{i+1} - \frac{\pi}{3} + \frac{\pi}{3}\\
&\leq& \frac{48}{s^k}
\end{eqnarray*}
