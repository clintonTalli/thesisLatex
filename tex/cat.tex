...
&& x - \frac{x^3}{6}\leq \sin x \leq x \quad\qquad 0< x < 1\\\hline
&&1 - \frac{x^2}{2}\leq \cos x \leq 1-\frac{x^2}{2} \qquad\qquad 0< x < 1\\\hline
...
$$
\begin{array}{rcl}
\sum_{i=1}^j \frac{\alpha_i^2}{2} &\leq& \frac{1}{2}\sum_{i=1}^j  \lr{ \frac{3}{2 s^{2\kappa}} }^2\\
&\leq&\frac{1}{2}\cdot  \lr{\frac{3}{2s^{2\kappa}}}^2 \cdot j\\
&\leq&\frac{1}{2}\cdot  \lr{\frac{3}{2s^{2\kappa}}}^2 \cdot u\\
&\leq&\frac{108s}{8s^{2\kappa}}\\
&\leq&\frac{14}{s^{\kappa}}\\  
\end{array}
$$
...
\end{center}
\end{minipage}\textbf{Lemma \ref{lem:aux-C} Conclusion.} We have thus shown that the triple $(\alpha, \beta, \delta)$ for any obstacle hexagon is small and bounded.  
