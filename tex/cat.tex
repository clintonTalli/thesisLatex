...
\end{center}
\end{figure}\section{Perturbed Root with Unit Disk Leaves Touching Graph Recongnition Problem (PRUDTGRP)}
...
\end{prob}\section{Proofs of Lemmas \ref{lem:s1Small} through \ref{lem:disksOfPathways}}
