...
\item The number of nodes in $T$ and the weights are polynomial in $\epsilon$ and $x$, the weights $\frac{\epsilon}{4}$ and $\frac{\epsilon}{4} + \zeta$ are polynomial.
\end{enumerate}
\end{lem} 
...
% $$ 
% \begin{array}{rcl}
% (i+1) \frac{2}{\sqrt{3}} &\leq& \frac{\epsilon}{4}\\
% (i+1) \frac{8}{\sqrt{3}} &\leq& \epsilon
% \end{array}
% $$
