...
By strict triangle inequality of the sides and diagonals of the quadrilateral $\lr{u_1, u_2, v_1, v_2}$, we have the following result:
...
The Hausdorff distance between the convex hulls of the centers in FINISH ME!!!!!.
