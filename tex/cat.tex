...
\end{array}
$$  
Similiaryly, the Hausdorff distance of $U$ and $S_2(\delta)$ is at most $H\lr{S_2(\delta), U}=\sqrt{2}\delta$.\section{Weighted Trees $T_i$}
...
\end{array}
$$
For any realization as an ordered disk contact graph where the radii of the disks equal the vertex weights, overlay the hexagon as the convex hull of the centers of the disks in the canonical arrangement.      
