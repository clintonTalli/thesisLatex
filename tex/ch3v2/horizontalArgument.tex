...
\chi_1 &=& \sqrt{\lr{1+(100N)^{-2}} + \lr{\lr{\frac{N}{2}-1}^2 + 3} - 2 \cdot \lr{\lr{\frac{N}{2}-1}^2 + 3}\cdot \lr{1+(100N)^{-2}}  \cos \zeta_1       }\\
...
\captionof{figure}{blah blah blab}\label{fig:deltaAlphaHorizontalDisplacement.pdf}
\end{center}
\end{minipage}
