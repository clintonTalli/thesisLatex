...
\textbf{Skinny Rhombus Motion.} The skinny rhombus hinged beneath an obstacle hexagon can rotate on its hinge with the flag. 
Figure \ref{fig:someRangeSkinny.pdf}(b) illustrates some range of motion $\omega_{1,2}$ that a skinny rhombus can rotate on its hinge with a flag.
Figure \ref{fig:someRangeSkinny.pdf}(a) shows the cannonical position of all objects where $\omega_{1,2}=0$.

\begin{minipage}{\linewidth}
\begin{center}
\includegraphics[width=.9\columnwidth]{graphics/someRangeSkinny.pdf}
\captionof{figure}{(a) A pair of vertically adjacent obstacle hexagons and their corresponding corridor in canonical position.  (b) shows the same obstacle hexagons and corridors with the exception that the skinny rhombus is not in cannonical position. (c) is the same as (b) with the exception that the obstacle hexagon $O_{1,2}$ has rotation displacement.}\label{fig:someRangeSkinny.pdf}
\end{center}
\end{minipage}
...
The vertical displacement from the rotation $\omega$ is $\sqrt{1+\lr{100N}^{-2}}\sin \omega$.  
...
\textbf{Rotational Displacement.}  Figure \ref{fig:someRangeSkinny.pdf}(c) shows a rotational displacement of $O_{1,2}$.  
The rotational displacement $\alpha_{1,2}$ creates a vertical displacement of $1 - \cos \alpha$



\textbf{Vertical Displacement.}
