...
\end{lem}
We need to show that the modified auxilary construction could not deform in such a way that any information the construction encoded is preserved and the functionality of the gadgets within the construction behave as stated in the description.
...
Given an arbitrary realization of $P$.
Each corridor in the realization has $t$ flags and one skinny rhombus. 
...
\begin{array}{rcl}
\gamma_j &\leq & \tan^{-1} \lr{\frac{1}{50N^2}}\\
&\leq& \frac{1}{50N^2} - \frac{1}{3}\frac{1}{\lr{50N^2}^3}
\end{array} 
\end{equation}
