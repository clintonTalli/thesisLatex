...
The formula for calculating hexagonal height of $J_z$ is $J_h (z) = 6z+1$; the formula for calcuating the hexagonal diameter is $J_d (z) = 4z+1$.
For sufficiently large $z$ we can encode the associated graph of any P3SAT instance into a hexagonal grid the interior of $J_z$.
We can define $z$ as a polynomial in terms of $n$ and $m$, $z(n,m)$.
