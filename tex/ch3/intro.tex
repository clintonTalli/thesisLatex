...
\captionof{figure}{The two shaded groups of horizontally adjacent hexagons represent two distinct variables in the honeycomb.}\label{fig:VariablesExample.pdf}
\end{center}
\end{minipage}
