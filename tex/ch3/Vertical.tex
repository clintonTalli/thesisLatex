...
Inequality \ref{eqn:vertical3} is continued in Inequality \ref{eqn:vertical4} where the right hand side is the shows the non-canonical height of $j$ obstacle hexagons with respect to rotation only and $j-1$ corridors:
