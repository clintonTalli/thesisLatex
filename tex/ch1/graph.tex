...
The crossing number $cr(G)$ of a graph is the lowest number of edge crossings of a drawing of the graph $G$.
...
A \textit{planar embedding} is an equivalence class of planar drawings and is described by the circular order of the neighrs of each vertex.
