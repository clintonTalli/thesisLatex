...
A drawing is said to be \textit{planar} if no two distinct edges cross.
For this thesis, we will strictly work with straigt line drawings.
...
An (planar) \textit{embedding} is a planar drawing with a corresponding circular order of the neighbors of each vertex.
