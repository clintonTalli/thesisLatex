...
\textit{length assignment} of a graph $G=(V,E)$ is $\ell:E \mapsto \bbr^+$. 
...
Like combinatorial embeddings are equivalency class of embeddings of the same circular order around vertices, we can also define equivalence classes of drawings with the same length assignment.
