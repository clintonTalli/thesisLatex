...
Like combinatorial embeddings are equivalence class of embeddings of the same circular order around vertices, we can also define equivalence classes of drawings with the same length assignment.
