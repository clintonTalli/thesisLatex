...
STATE THE CARPENTER'S RULE THEOREM.
By Carpenter's Rule theorem, every realization of a path linkage can be continuously moved (without self-intersection) to any other realization \cite{CDR03,Str05}.
