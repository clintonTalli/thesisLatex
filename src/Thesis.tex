...
% \committee{Dr. Csa'ba Toth}{Dr. Silvia Fernandez}{Dr. John Dye}
...
%\abstract{Abstract Goes Here.}
\input{thesisIntro}
\input{thesisLinkages}
\input{thesisConfigurationSpaces}
\input{thesisDiskArrangement}
\input{thesisSatisfiability}
%\input{thesisCirclePacking}
\input{references}
\end{document}
