...
\begin{center}
\begin{tabular}{|p{.2\textwidth}|p{.79\textwidth}|}\label{table:configurationSpace-1}
Object Type&Definition of Reconfiguration\\\hline
Graph&a continuous motion of the vertices that preserves the lengths of the edges and never causes 
the edges to intersect.\\\hline
Linkage&same as graph\\\hline
