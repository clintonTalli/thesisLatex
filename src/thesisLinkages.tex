...
the linkage $G$ into the plane is said to be the \textit{embedding}, i.e. $l : E \mapsto 
\bbR^{2}$.  We consider a \textit{realization} of a linkage is range of $l$, i.e. $l(E)$. 
...
$G$ into the plane is said to be the \textit{embedding}, i.e. $l : \PP \mapsto \bbR^{2}$.  We 
consider a \textit{realization} of a polygonal linkage is range of $l$, i.e. $l(\PP)$.
